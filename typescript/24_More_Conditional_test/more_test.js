...
console.log("Test for inequality: ", ('Apple') != 'Orange');
...
console.log("Numerical test Inequality :", (30) != 35);
...
const fruites = ["Mango", "Banana", "Orange"];
...
//Test whether an item is in a array
const fruite = ["Mango", "Banana", "Orange"];
